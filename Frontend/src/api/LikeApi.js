...
const Like_API_URL = import.meta.env.MODE === "development"
    ? "http://localhost:8000/api/v1/likes"  // Local backend
    : "https://youtube-ydae.onrender.com/api/v1/likes";  // Deployed backend
